<template>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
        <g fill="currentColor">
            <path d="M1.863,2.581 C0.829,3.766 0.164,5.277 0.0430000001,6.944 L1.014,6.944 C1.135,5.551 1.699,4.285 2.565,3.282 L1.863,2.581 L1.863,2.581 Z" class="si-glyph-fill">
