...
const showQr = ()=>{
    if(!props.membership.invite) return;
    props.clientState.viewingQr = true;
}

const toggleEditor = ()=>{
    if(!props.membership.modify_poll) return;
    props.clientState.editing = !props.clientState.editing;
}
...
<template>
    <div class="actions">
        ...
        <div 
            ...
            :class="{'forbidden': !membership.can_answer}"
        >
        ...
        <div 
            class="action" 
            :class="{'forbidden': !membership.see_progress}"
        >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
